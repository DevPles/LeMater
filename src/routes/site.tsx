    ...
    <section style={{ paddingTop: 40, minHeight: "75vh", display: "flex", flexDirection: "column" }}>
      <div style={{ display: "flex", flex: 1, flexWrap: "wrap", alignItems: "flex-start" }}>
        ...
        <div style={{ flex: "0 1 380px", background: c.warm, display: "flex", flexDirection: "column", justifyContent: "flex-end", position: "relative", overflow: "hidden", padding: 32, minHeight: 440, alignSelf: "center", borderRadius: 16 }}>
          ...
          />
          <LiquidCard bgOpacity={0} style={{ padding: "20px 24px", display: "flex", alignItems: "center", gap: 16, position: "relative", zIndex: 2, background: "linear-gradient(135deg, rgba(255,255,255,0.18), rgba(255,255,255,0.06))", backdropFilter: "blur(18px) saturate(180%) contrast(110%)", WebkitBackdropFilter: "blur(18px) saturate(180%) contrast(110%)", borderColor: "rgba(255,255,255,0.45)", boxShadow: "inset 0 1px 0 0 rgba(255,255,255,0.5), inset 0 -1px 0 0 rgba(255,255,255,0.15), 0 10px 30px -12px rgba(0,0,0,0.25)" }}>
