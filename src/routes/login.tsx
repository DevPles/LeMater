...
.ls-ring-pulse {
  ...
  animation: lsRingPulse 2s ease-out infinite;
}
.ls-logo {
  width: 84px;
  height: 84px;
...
.ls-title {
  ...
  animation: lsFadeUp 0.6s ease-out 0.2s both;
}
.ls-subtitle {
  margin: 8px 0 22px;
  font-size: 13px;
  ...
  text-transform: uppercase;
  color: ${GOLD};
  animation: lsFadeUp 0.6s ease-out 0.32s both;
}
.ls-progress {
  width: 180px;
  height: 2px;
...
.ls-progress > span {
  ...
  animation: lsProgress 1.6s ease-in-out infinite;
}
