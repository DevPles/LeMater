...
export function SpotifyIcon({ className, size = 22 }: IconProps) {
  return (
    ...
    >
      ...
      <path
        fill="#fff"
        d="M122.7 117.2c-1.6 2.6-5.1 3.5-7.7 1.9-21.1-12.9-47.7-15.8-79-8.7-3 .7-6-1.2-6.7-4.2-.7-3 1.2-6 4.2-6.7 34.3-7.8 63.7-4.5 87.4 10 2.6 1.6 3.5 5 1.8 7.7zm10.3-22.9c-2 3.2-6.3 4.3-9.5 2.3-24.2-14.9-61.1-19.2-89.8-10.5-3.6 1.1-7.5-1-8.6-4.6-1.1-3.6 1-7.5 4.6-8.6 32.7-9.9 73.4-5.1 101.2 12 3.2 2 4.2 6.2 2.1 9.4zm.9-23.8C105 53.2 57.4 51.6 30.5 59.8c-4.3 1.3-8.8-1.1-10.1-5.4-1.3-4.3 1.1-8.8 5.4-10.1 30.9-9.4 83.5-7.6 116.4 11.9 3.9 2.3 5.2 7.3 2.9 11.2-2.3 3.9-7.3 5.2-11.2 2.9z"
      />
    </svg>
  );
}
