...
function CidadesPopover({
  ...
  return (
    <details className="relative">
      ...
      <div className="absolute right-0 mt-1 z-50 w-64 max-h-72 overflow-auto bg-card border border-border rounded-xl shadow-lg p-2">
